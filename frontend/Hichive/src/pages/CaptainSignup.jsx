...
const CaptainSignup = () => {
  ...
  const submithandler = (e) => {
    e.preventDefault();
    setcaptaindata({ username:{firstname: firstname, lastname: lastname} , email: email, pass: pass});
    ...
    <div className="relative flex flex-col justify-center items-center min-h-screen bg-gray-100 px-4">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md border-4 border-gray-300">
        ...
        <p className="text-center mt-4">
          Already a Captain? <Link to="/captain-login" className="text-blue-600">Log in</Link>
        </p>
      </div>
